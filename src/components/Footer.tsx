  ...
  return (
    <footer className="py-12 px-6 border-t border-border">
      <div className="max-w-4xl mx-auto text-center">
        <p className="font-heading text-2xl text-foreground mb-4">Restaurant Jaipur (Proche Place Wilson/ Rue coupée de Longvic)</p>
        ...
        <p className="text-muted-foreground text-xs font-light">
          © {new Date().getFullYear()} Restaurant Jaipur (Proche Place Wilson/ Rue coupée de Longvic). Tous droits réservés.
        </p>
      </div>
    </footer>
  );
