...
const schedule = [
  ...
  { day: "Dimanche", hours: "12h00 – 14h00 / 19h00 – 22h00" },
];

const MAPS_EMBED_URL =
  "https://maps.google.com/maps?q=47.3155924,5.0455903&z=17&output=embed";
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          >
            ...
            <div>
              ...
              <a
                href="mailto:contact@19-rue-dauxonne.fr"
                className="text-primary font-body tracking-wide hover:text-terracotta hover:tracking-wider transition-all duration-300"
              >
                contact@19-rue-dauxonne.fr
              </a>
            </div>
          </div>
          <div
